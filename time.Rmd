...
## Input
start_date_time <- "2024-08-01 00:00:00"
end_date_time <- "2024-08-01 23:59:59"
...
suppressMessages({
  ...
  final_df <- trades_df_filtered %>%
    select(
      id, account_id, close_time_str, open_time_str, commission, login, FinalLot, 
  ...
  write_csv(final_df, paste0("C:/Users/tiyasa/Documents/output_", date_part, ".csv"))
